    ...
    <section id="stations-section" className="space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2">
        ...
        <div className="text-xs text-slate-400">
          Showing <strong className="text-white">{filteredAndSorted.length}</strong> stations
        </div>
      </div>

      {/* Filter & Search Bar */}
      <div className="flex flex-col md:flex-row items-stretch md:items-center justify-between gap-3 bg-slate-900 p-3 rounded-2xl border border-slate-800 shadow-lg">
        {/* Search Input */}
        <div className="relative flex-1">
          ...
          <input
            ...
            className="w-full bg-slate-800/80 border border-slate-700 rounded-xl pl-9 pr-4 py-2 text-xs text-white placeholder-slate-400 focus:outline-none focus:border-blue-500 transition-colors"
          />
        </div>
        ...
        {/* Sort Selector */}
        <div className="flex items-center gap-1.5 shrink-0 bg-slate-800/80 px-2.5 py-1.5 rounded-xl border border-slate-700 text-xs text-slate-300">
          ...
          >
            <option value="temp-desc" className="bg-slate-900 text-white">Highest Temp</option>
            <option value="temp-asc" className="bg-slate-900 text-white">Lowest Temp</option>
            <option value="rain-desc" className="bg-slate-900 text-white">Highest Rain</option>
            <option value="wind-desc" className="bg-slate-900 text-white">Strongest Wind</option>
            <option value="name" className="bg-slate-900 text-white">Station Name</option>
          </select>
        </div>
      </div>
            ...
            >
              <div>
                ...
                <div className="flex items-start justify-between gap-2 mb-3">
                  <div>
                    <div className="flex items-center gap-1.5">
                      ...
                      {hasRain && (
                        <span className="text-[10px] px-1.5 py-0.5 rounded bg-blue-500/20 text-blue-300 font-semibold animate-pulse">
                          Raining
                        </span>
                      )}
                    </div>
                  ...
                  <button
                    ...
                    className="p-1.5 rounded-lg bg-slate-800 text-slate-400 hover:text-white hover:bg-blue-600 transition-colors cursor-pointer"
                  >
                ...
                <div className="grid grid-cols-2 gap-2 text-xs">
                  ...
                  <div className="p-2 rounded-xl bg-slate-800/60 border border-slate-700/50">
                    <span className="text-slate-400 text-[10px] flex items-center gap-1">
                      <CloudRain className="w-3 h-3 text-blue-400" /> 5-Min Rain
                    </span>
                    <span className="text-base font-extrabold text-white mt-0.5 block">
                  ...
                  <div className="p-2 rounded-xl bg-slate-800/60 border border-slate-700/50">
                    <span className="text-slate-400 text-[10px] flex items-center gap-1">
                      <Wind className="w-3 h-3 text-emerald-400" /> Wind Flow
                    </span>
